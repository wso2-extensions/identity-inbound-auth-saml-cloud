...
public class SampleConfigs extends AbstractInboundAuthenticatorConfig {

    private static Log log = LogFactory.getLog(SAMLAuthenticatorConfigs.class);

    //This is the key
    @Override public String getAuthKey() {
        return null;
    }

    @Override public String getConfigName() {
        return SAMLSSOConstants.SAMLFormFields.SAMPLE;
    }
    ...
    @Override public Property[] getConfigurationProperties() {
        ...
        enableSigValidation
                .setDisplayName("Enable Signature Validation in Authentication Requests and Logout " + "Requests");
        ...
        return new Property[] { issuer, appType, acsurls, acsindex, defaultacs, nameid, alias, signAlgo, digestAlgo,
                ...
                enableDefaultAtrProf, enableAudienceRestriction, audiences, enableRecipients, receipients, enableIDPSSO,
                enableIDPSLO, idpSLOUrls };
    }

    @Override public String getRelyingPartyKey() {
